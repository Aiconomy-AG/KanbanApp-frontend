...
function App() {
  ...
  useEffect(() => {
    ...
    async function completeConnect() {
      ...
      try {
        const response = await apiRequest('/api/trello/connect', {
          method: 'POST',
          token,
            ...
            <div className="card form-card trello-card">
              <div className="panel-head">
                <div>
                  ...
                  {trelloStatus.connected && !trelloSyncing ? (
                    <p className="muted trello-sync-note">
                      All boards stay in sync automatically.
                    </p>
                  ) : null}
                </div>
              </div>
              {trelloStatus.connected ? (
                <button
                  ...
                  disabled={boardBusy || trelloSyncing}
                >
                  Disconnect Trello
                </button>
              ) : (
